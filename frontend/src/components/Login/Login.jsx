  ...
  return (
    <>
      <div className="">
        ...
        >
          <div className="absolute lg:w-[450px] sm:w-[350px] w-[300px] my-16 inset-0 bg-white flex rounded mx-auto mb-8">
            <div className="text-center mx-auto w-full pt-5 pb-5">
              <p className="text-2xl font-bold text-gray-800 my-1">Sign in</p>
              <p>
